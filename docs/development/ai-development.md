...
rules live in [`AGENTS.md`](../../AGENTS.md) (canonical, binding on agents) and the ADRs
...
[`AGENTS.md`](../../AGENTS.md) and the ADRs win.
...
amounts of code. See [`docs/architecture/foundation-0-design-baseline.md`](../architecture/foundation-0-design-baseline.md)
§1 and ADR-0010 for the full rationale and authority boundaries.

## What agents can and cannot do

See [`AGENTS.md`](../../AGENTS.md) in full. In short: agents work through branches and pull
...
substitutes for the Definition of Done in [`AGENTS.md`](../../AGENTS.md), which still
...
the project's AI review of every PR. See [`IMPLEMENTATION_PLAN.md`](../../IMPLEMENTATION_PLAN.md) Phase 3b
for what is and isn't done.

## AI-on-AI review

Because submitted code may itself be AI-generated, both reviewers (and any
human reviewer) should actively watch for the failure modes in [`AGENTS.md`](../../AGENTS.md)
