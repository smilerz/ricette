...
- **Item 2 (hard-deny), each attempted directly, not assumed**:
  ...
  - *Self-merge*: **BLOCKED** — see PR #2 (opened from this branch): `gh pr merge` on it was refused by the classifier. (Details recorded here after that PR exists; see commit history.)
